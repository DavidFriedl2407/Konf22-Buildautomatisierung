...
public class Schleifen5 {
    public static void main(String[] args) {
        ...
        int anotherRandomNumber = numberGenerator.nextInt(20) + 1;
        int anotherRandomNumber2 = numberGenerator.nextInt(20) + 1;
        int e = 0;
        ...
        if (anotherRandomNumber > anotherRandomNumber2) {
            for (int j = anotherRandomNumber; j >= anotherRandomNumber2; j--) {
        ...
        if (anotherRandomNumber2 > anotherRandomNumber) {
            for (int j = anotherRandomNumber2; j >= anotherRandomNumber; j--) {
                System.out.println(j);
                j--;
            }
